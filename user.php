...
<div class="introduction-container" style="max-width:100%; margin-bottom:0%; padding-bottom:0%;" >
    ...
    <div class="row" >
        <div class="col-md-12" >
            <div class="modal-box" >
                ...
                <!-- Modal -->
                <div class="modal fade" style="backdrop-filter: blur(5px); background-color: rgba(255, 255, 255, 0.2);" id="subscribeCard" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            ...
                            <div class="modal-body">
                                ...
                                <div style="padding-top: 10%;"> 
                                   <div class="form-group">
                                    <h1  class="form-control"><i class="fa fa-star"></i>  Create unlimited Trees</h1>
                                    <h1  class="form-control"><i class="fa fa-star"></i>  Save Your Trees for forever</h1>
                                    <h1  class="form-control"><i class="fa fa-star"></i>  Multiple users can access your tree</h1> 
                                    <h1 class="price"> With Only Rs 100 </h1> 
                                  </div>
                                  

                                </div>
                                
                                <a  href="cv.php" class="btn btn-login" type="button" ><span >Try Free For 7 Days </span></a>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <div  style="text-align: center;" class="tree">
   ...
   <button class = "btn-tree" type="button" data-toggle="modal" data-target="#subscribeCard" >Create Tree</button>
